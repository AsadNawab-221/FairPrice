<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         <h3>Contact Us.</h3>
         <a href="tel:9800000000"><i class="fas fa-phone"></i> +920000000000</a>
         <a href="tel:9900000000"><i class="fas fa-phone"></i> +920000000000</a>
         <a href="mailto:harshchy143@gmail.com"><i class="fas fa-envelope"></i> Fairprice@gmail.com</a>
         <a href="https://www.google.com/myplace"><i class="fas fa-map-marker-alt"></i> Karachi, Pakistan </a>
      </div>
   ...
   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>Fairprice.com</span> | all rights reserved!</div>
